...
static const unsigned int godart_keymap[] = {
...
static struct matrix_keymap_data godart_keymap_data = {
        .keymap_size    = ARRAY_SIZE(godart_keymap),
        .keymap         = godart_keymap,
};


static struct pmic8058_keypad_data godart_keypad_data = {
	.input_name		= "godart_keypad",
	.input_phys_device	= "godart_keypad/input0",
	.num_rows		= 5,
	.num_cols		= 5,
	.rows_gpio_start	= 8,
	.cols_gpio_start	= 0,
	...
	.row_hold_ns		= 91500,
	.wakeup			= 1,
	.keymap_data            = &godart_keymap_data,
};
...
static struct platform_device godart_batt_device = {
	.name 		    = "godart-battery",
	.id		    = -1,
...
static void godart_switch_init(void)
{
...
MACHINE_START(GODART, "GT-I8560 Board")
