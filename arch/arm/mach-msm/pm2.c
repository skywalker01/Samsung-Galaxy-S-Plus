...
/* hk46.song_20110822 ++ */
#if defined(CONFIG_MACH_ANCORA_TMO)&&defined(CONFIG_CONDITIONAL_POWER_COLLAPSE_EAR_MIC_TX)
struct msm_pm_platform_data *msm_pm_modes;

EXPORT_SYMBOL(msm_pm_modes);
#else
